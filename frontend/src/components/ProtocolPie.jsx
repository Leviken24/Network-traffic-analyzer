...
export default function ProtocolPie({ features }) {
  ...
  return (
    <div className="bg-transparent p-4 rounded-lg shadow-sm border border-gray-100 h-full flex flex-col">
      <h3 className="text-lg font-semibold text-purple mb-4">Protocol Mix</h3>
