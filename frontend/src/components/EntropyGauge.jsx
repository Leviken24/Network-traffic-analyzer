    ...
    <div className="mb-4 last:mb-0">
      <div className="flex justify-between text-sm mb-1">
       ...
       <div className="bg-white rounded-lg p-4"></div>
        <span className="text-red-500 font-mono">{Number(value).toFixed(2)}</span>
      </div>
...
export default function EntropyGauge({ features }) {
  ...
  return (
    <div className="bg-red p-4 rounded-lg red-sm border border-red-100 h-full flex flex-col">
      <h3 className="text-lg font-semibold text mb-4">Entropy Metrics</h3>
