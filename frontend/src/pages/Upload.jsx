    ...
    return (
      <div className="max-w-3xl mx-auto mt-10">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-extrabold text-cyan-100 mb-4">Network Traffic Analyzer</h1>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
          ...
          <div 
            {...getRootProps()} 
            className="bg-black/30 backdrop-blur-xl border-2 border-dashed border-red-400/30 rounded-2xl p-8 shadow-[0_0_30px_rgba(255,0,0,0.08)]">
